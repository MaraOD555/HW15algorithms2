...
public class Sorting {
    ...
    public static void main(String[] args){
        ...
        double timeForSInsertSort = timeForSInsertSort(5);
        System.out.println("время сортировки вставки " + timeForSInsertSort + " мс.");
    }
    ...
    private static double timeForSInsertSort(int iteration){
        double sum = 0;
        for (int i = 0; i < iteration; i++) {
            int[] array = generateArray(100000);
            long start = System.currentTimeMillis();
    ...
    private static void swapElements (int[] arr, int indexA, int indexB){ //метод избавления от дублирующего кода
        int tmp = arr[indexA];
    ...
    private static void sortInsertion(int[] arr) { //самый быстрый способ сортировки
